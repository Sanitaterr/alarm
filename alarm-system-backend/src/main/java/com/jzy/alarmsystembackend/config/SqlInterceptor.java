...
import com.jzy.alarmsystembackend.annotations.SqlPrint;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        try {
            ...
            return proceed;
                ...
                printSql(invocation, endTime, startTime);
        }
    }

    private static void printSql(Invocation invocation, Long endTime, Long startTime) {
